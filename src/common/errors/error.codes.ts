export enum ErrorCodes {
    ...
    GATEWAY_REQUEST_BODY_TOO_LARGE = 'GATEWAY_REQUEST_BODY_TOO_LARGE',
    GATEWAY_TARGET_NOT_CONFIGURED = 'GATEWAY_TARGET_NOT_CONFIGURED',
    GATEWAY_UPSTREAM_UNAVAILABLE = 'GATEWAY_UPSTREAM_UNAVAILABLE',
    GATEWAY_RESPONSE_BODY_TOO_LARGE = 'GATEWAY_RESPONSE_BODY_TOO_LARGE',
    UNSAFE_EXTERNAL_URL = 'UNSAFE_EXTERNAL_URL',
    LLM_NOT_CONFIGURED = 'LLM_NOT_CONFIGURED',
    LLM_UPSTREAM_UNAVAILABLE = 'LLM_UPSTREAM_UNAVAILABLE',
    ML_SUGGESTIONS_DISABLED = 'ML_SUGGESTIONS_DISABLED',
    ML_UPSTREAM_UNAVAILABLE = 'ML_UPSTREAM_UNAVAILABLE',
}
